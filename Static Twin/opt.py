...
def get_opts():
    ...
    # dataset parameters
    parser.add_argument('--root_dir', type=str, default='/data/shenchengkang/sck/thyroid/data_train/000',
                        help='root directory of dataset')
    parser.add_argument('--dataset_name', type=str, default='THY',
                        choices=['THY'],
    ...
    parser.add_argument('--num_gpus', type=int, default=1,
                        help='number of gpus')
    parser.add_argument('--lr', type=float, default=1e-4, #1e-2 dy:1e-4
                        help='learning rate')
